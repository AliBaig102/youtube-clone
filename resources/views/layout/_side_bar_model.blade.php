...
<div class="side_bar_popup h-[max(100vh,50vw)] w-[clamp(200px,15vw,50%)] bg-white">
    ...
    <ul>
        <li class="active" onclick="window.location='{{route('home')}}'"><iconify-icon icon="ic:baseline-home"></iconify-icon> <a class="translated_text">Home</a></li>
        <li onclick="window.location='{{route('shorts')}}'"><iconify-icon icon="bx:movie-play"></iconify-icon><a class="translated_text">Shorts</a></li>
