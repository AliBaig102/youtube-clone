<div class="side_bar h-[max(95vh,46vw)] w-[16%] fixed top-[--4vw] left-0 overflow-scroll">
    <ul class="exists">
        <li class="active"><iconify-icon icon="ic:baseline-home"></iconify-icon> <a class="translated_text">Home</a></li>
        <li><iconify-icon icon="bx:movie-play"></iconify-icon><a class="translated_text">Shorts</a></li>
        <li><iconify-icon icon="material-symbols:subscriptions-outline"></iconify-icon><a class="a_small_text translated_text">Subscription</a></li>
    </ul>
    <hr>
    <ul class="exists">
        <li><iconify-icon icon="material-symbols:video-library-outline"></iconify-icon> <a class="translated_text">library</a></li>
        <li><iconify-icon icon="material-symbols:history"></iconify-icon> <a class="translated_text">history</a></li>
    </ul>
    <hr>
    <div>
        <p class="w-80% ml-5 my-[--03vw] text-[.9vw] translated_text">Sign in to like videos, comment, and subscribe.</p>
